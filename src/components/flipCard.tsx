            ...
            <div class="h-72 text-xl text-center flex flex-col items-center text-3xl">
                <Switch>
                    <Match when={!isStarted()} keyed={true}>
                        ...
                        <button onClick={() => setStarted(true)} class="mt-8 text-2xl py-2 px-6 rounded-md bg-pink-400">Let's start</button>
                    </Match>
                    <Match when={isStarted()} keyed={true}>
                        ...
                        <Show when={isBackfaceVisible()} keyed={true}>
                            ...
                            <div class="flex gap-3 mt-8">
                                ...
                                }} class="py-2 px-4 rounded-md bg-pink-400 w-40 text-xl">Retry</button>
                                <button onClick={() => {
                                    setBackfaceVisible(false)
                                ...
                                }} class="py-2 px-4 rounded-md bg-pink-400 w-40 text-xl">Alright</button>
                            </div>
                        </Show>
                    </Match>
                </Switch>
